...
var CustomOverlayMap = function (_a) {
    var position = _a.position, children = _a.children, option = _a.option;
    var map = react_1.useContext(Map_1.KakaoMapContext);
    return (react_1.default.createElement(CustomOverlay, __assign({}, option, { map: map, position: new kakao.maps.LatLng(position.lat, position.lng) }), children));
};
exports.default = CustomOverlayMap;
var CustomOverlay = (function (_super) {
    ...
    CustomOverlay.prototype.componentDidMount = function () {
        var _a = this.props, map = _a.map, position = _a.position, xAnchor = _a.xAnchor, yAnchor = _a.yAnchor, zIndex = _a.zIndex, clickable = _a.clickable, content = _a.content;
        var el = this.el;
...
//# sourceMappingURL=CustomOverlayMap.js.map