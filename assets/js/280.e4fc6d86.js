...
/* harmony export */ });
/* harmony import */ var outvariant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25307);
/* harmony import */ var _types_36e5ec0d_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10627);
...
var types_36e5ec0d = __webpack_require__(10627);
...
var base_80a1f760 = __webpack_require__(27204);
...
var SandpackNode = /** @class */ (function (_super) {
    ...
    SandpackNode.prototype.createShellProcessFromTask = function (files) {
        return (0,types_36e5ec0d._)(this, void 0, void 0, function () {
            ...
            return (0,types_36e5ec0d.a)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packageJsonContent = (0,client_utils_7a723432.r)(files["/package.json"]);
                        this.emulatorCommand = (0,client_utils_7a723432.b)(packageJsonContent);
                                ...
                                return (0,types_36e5ec0d.a)(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 4:
                                            ...
                                            this._modulesCache.set(event.path, (0,client_utils_7a723432.w)(content));
                                            return [3 /*break*/, 9];
                                        case 5:
                                            this.dispatch({
                                                type: "fs/remove",
                                        ...
                                        case 7:
                                            ...
                                            this._modulesCache.set(event.newPath, (0,client_utils_7a723432.w)(newContent));
                                            return [3 /*break*/, 9];
    ...
    SandpackNode.prototype.updateSandbox = function (setup) {
        var _this = this;
        var _a;
        var modules = (0,client_utils_7a723432.f)(setup.files);
        /**
         * Update file changes
         */
        if (((_a = this.emulatorShellProcess) === null || _a === void 0 ? void 0 : _a.state) === "running") {
            Object.entries(modules).forEach(function (_a) {
                ...
                if (!_this._modulesCache.get(key) ||
                    (0,client_utils_7a723432.r)(value) !== (0,client_utils_7a723432.r)(_this._modulesCache.get(key))) {
