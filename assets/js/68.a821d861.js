...
// EXTERNAL MODULE: ../node_modules/.pnpm/@codesandbox+sandpack-client@2.13.8/node_modules/@codesandbox/sandpack-client/dist/utils-52664384.mjs
var utils_52664384 = __webpack_require__(48738);
...
// EXTERNAL MODULE: ../node_modules/.pnpm/@codesandbox+sandpack-client@2.13.8/node_modules/@codesandbox/sandpack-client/dist/base-80a1f760.mjs
var base_80a1f760 = __webpack_require__(54461);
// EXTERNAL MODULE: ../node_modules/.pnpm/@codesandbox+sandpack-client@2.13.8/node_modules/@codesandbox/sandpack-client/dist/consoleHook-59e792cb.mjs
var consoleHook_59e792cb = __webpack_require__(90223);
// EXTERNAL MODULE: ../node_modules/.pnpm/outvariant@1.4.0/node_modules/outvariant/lib/index.mjs
var lib = __webpack_require__(66496);
// EXTERNAL MODULE: ../node_modules/.pnpm/dequal@2.0.3/node_modules/dequal/dist/index.mjs
var dist = __webpack_require__(80589);
;// CONCATENATED MODULE: ../node_modules/.pnpm/@codesandbox+sandpack-client@2.13.8/node_modules/@codesandbox/sandpack-client/dist/clients/node/index.mjs
...
function loadPreviewIframe(iframe, url) {
    return (0,utils_52664384._)(this, void 0, void 0, function () {
        var contentWindow, TIME_OUT, MAX_MANY_TIRES, tries, timeout;
        return (0,utils_52664384.a)(this, function (_a) {
            contentWindow = iframe.contentWindow;
            (0,utils_52664384.n)(contentWindow, "Failed to await preview iframe: no content window found");
            TIME_OUT = 90000;
            MAX_MANY_TIRES = 20;
            tries = 0;
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var triesToSetUrl = function () {
                        ...
                        if (tries >= MAX_MANY_TIRES) {
                            reject((0,utils_52664384.c)("Could not able to connect to preview."));
                            return;
                        }
...
var scripts = [
    ...
    {
        code: "function consoleHook({ scope }) {" + consoleHook_59e792cb.c + "\n};",
        id: "consoleHook",
    },
...
var SandpackNode = /** @class */ (function (_super) {
    (0,utils_52664384.g)(SandpackNode, _super);
    function SandpackNode(selector, sandboxInfo, options) {
        if (options === void 0) { options = {}; }
        var _this = _super.call(this, selector, sandboxInfo, (0,utils_52664384.h)((0,utils_52664384.h)({}, options), { bundlerURL: options.bundlerURL })) || this;
        _this._modulesCache = new Map();
        _this.messageChannelId = (0,consoleHook_59e792cb.g)();
        _this._initPromise = null;
        _this.emitter = new consoleHook_59e792cb.E();
        // Assign iframes
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        this.dispatch({
                            ...
                            title: (0,consoleHook_59e792cb.a)(err_1),
                        });
    ...
    SandpackNode.prototype.createShellProcessFromTask = function (files) {
        return (0,utils_52664384._)(this, void 0, void 0, function () {
            ...
            var _a;
            var _this = this;
            return (0,utils_52664384.a)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packageJsonContent = (0,consoleHook_59e792cb.r)(files["/package.json"]);
                        this.emulatorCommand = (0,consoleHook_59e792cb.b)(packageJsonContent);
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("exit", function (exitCode) {
                                _this.dispatch({
                                    ...
                                    action: "notification",
                                    notificationType: "error",
                                    title: (0,utils_52664384.c)("Error: process.exit(".concat(exitCode, ") called.")),
                                });
                            })];
                    case 1:
                        // Shell listeners
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("progress", function (data) {
                                ...
                                if (data.state === "command_running" ||
                                    ...
                                    _this.dispatch({
                                        type: "shell/progress",
                                        data: (0,utils_52664384.h)((0,utils_52664384.h)({}, data), { command: [
    ...
    SandpackNode.prototype.manageIframes = function (selector) {
        ...
        if (typeof selector === "string") {
            ...
            (0,utils_52664384.n)(element, "The element '".concat(selector, "' was not found"));
        ...
        (0,utils_52664384.n)(this.iframe.parentNode, "The given iframe does not have a parent.");
        /**
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.emulator.fs.watch(["*"], [
                                ...
                                ".config",
                                ".vuepress",
                            ], function (message) { return (0,utils_52664384._)(_this, void 0, void 0, function () {
                                ...
                                return (0,utils_52664384.a)(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 4:
                                            ...
                                            this._modulesCache.set(event.path, (0,consoleHook_59e792cb.w)(content));
                                            return [3 /*break*/, 9];
                                        case 5:
                                            this.dispatch({
                                                type: "fs/remove",
                                        ...
                                        case 7:
                                            ...
                                            this._modulesCache.set(event.newPath, (0,consoleHook_59e792cb.w)(newContent));
                                            return [3 /*break*/, 9];
                                        ...
                                        case 10:
                                            ...
                                            this.dispatch({
                                                ...
                                                action: "notification",
                                                notificationType: "error",
                                                title: (0,consoleHook_59e792cb.a)(err_2),
                                            });
                                            return [3 /*break*/, 11];
    ...
    SandpackNode.prototype.updateSandbox = function (setup) {
        var _this = this;
        var _a;
        var modules = (0,consoleHook_59e792cb.f)(setup.files);
        /**
         * Update file changes
         */
        if (((_a = this.emulatorShellProcess) === null || _a === void 0 ? void 0 : _a.state) === "running") {
            Object.entries(modules).forEach(function (_a) {
                ...
                if (!_this._modulesCache.get(key) ||
                    (0,consoleHook_59e792cb.r)(value) !== (0,consoleHook_59e792cb.r)(_this._modulesCache.get(key))) {
        ...
        Object.entries(modules).forEach(function (_a) {
            var key = _a[0], value = _a[1];
            _this._modulesCache.set(key, (0,consoleHook_59e792cb.w)(value));
        });
    };
    SandpackNode.prototype.dispatch = function (message) {
        ...
        return (0,utils_52664384._)(this, void 0, void 0, function () {
            var _c;
            return (0,utils_52664384.a)(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = message.type;
                        switch (_c) {
...
/* harmony export */ });
/* harmony import */ var outvariant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66496);
/* harmony import */ var _utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48738);
